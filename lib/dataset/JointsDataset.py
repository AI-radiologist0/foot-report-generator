...
from utils.transforms import fliplr_joints, fliplr_joints_fixed
...
class JointsDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.is_train:
            ...
            # if self.flip and random.random() <= cfg.DATASET.RANDOM_P:
            if self.flip and random.random() <= 0.5:
                ...
                # joints, joints_vis = fliplr_joints_fixed(
                #     joints, joints_vis, data_numpy.shape[1], self.flip_pairs)
