...
MODEL_NAME = "deepseek-r1-distill-llama-70b"  # Groq model options: llama3-8b-8192, llama3-70b-8192, mixtral-8x7b-32768
...
# Output file name
OUTPUT_FILE = "deepseek_report_old1_done.xlsx"
...
logging.basicConfig(
    ...
    handlers=[logging.FileHandler("groq_report_processor.log"), logging.StreamHandler()]
)
...
def main():
    ...
    print("\n🔍 Medical Report Enhancement Tool using Groq 🔍")
    print("==============================================\n")
